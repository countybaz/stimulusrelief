...
const Header = () => {
  return (
    <header className="bg-white border-b border-gray-200 py-5 px-4 shadow-sm">
      <div className="container mx-auto">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-2 flex items-center bg-gray-50 px-4 py-2 rounded-md text-sm border border-gray-200">
